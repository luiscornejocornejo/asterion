    ...
    */
    ...
    'connections' => [
        ...
        'mysql3' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => 'db-getdata-do-user-4274947-0.b.db.ondigitalocean.com',
            'port' => env('DB_PORT', '25060'),
            'database' => 'sienna',
            'username' => 'doadmin',
            'password' => 'AVNS_xGdH4_0RiAKR6OAiDr_',
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'pgsql' => [
            'driver' => 'pgsql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST', 'conversations-do-user-4274947-0.c.db.ondigitalocean.com'),
            'port' => env('DB_PORT', '25060'),
            'database' => env('DB_DATABASE', 'defaultdb'),
            'username' => env('DB_USERNAME', 'doadmin'),
            'password' => env('DB_PASSWORD', 'AVNS_YHPqI3EmxSonH2GuBr7'),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => 'public',
