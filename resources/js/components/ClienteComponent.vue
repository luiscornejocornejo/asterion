        ...
        <div class="card">
                            ...
                            <div class="card-body py-0 mb-3" data-simplebar style="max-height: 600px;min-height: 600px;">
                                ...
                                <section v-else>
                                    ...
                                    <div v-else v-for="currency in info " style="box-shadow: 4px 4px rgba(0,0,0,0.25);"
                                        ...
                                        v-on:click="pasar(currency.depto, currency.nombredelcliente, currency.lastupdate, currency.ticket_id, currency.source, currency.creacion, currency.topic, currency.estado, currency.priority_desc, currency.priority_color, currency.asignado, currency.user_id, currency.priority_color, currency.chat_link,currency.mail,currency.telefono,currency.latitud,currency.longitud,currency.plan_name,currency.whatsapp_nro,currency.client_id)"
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-6 align-self-start" style="display:inline-block;">
                                                        <h5 class="mt-0 mb-0 small fw-bold"
                                                            style="color: #727CF5;font-size: 14px;">
                                                            {{ currency.topic }}</h5>
                                                    </div>
                                                    <div class="col-6 align-self-end" style="display:inline-block;">
                                                        <span class="float-end fw-bold"
                                                            style="color: #98a6ad;font-size: 12px;">{{
                                                ...
                                                <div class="row">
                                                    <div class="col-6 align-self-start" style="display:inline-block;">
                                                        ...
                                                        <h5 v-if="currency.source == 'Whatsapp'" style="color: #98a6ad;">
                                                            <svg style="vertical-align: middle;"
                                                                xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                                fill="currentColor" class="bi bi-whatsapp" color="#25D366"
                                                                viewBox="0 0 16 16">
                                                                <path
                                                            ...
                                                            </svg> {{ currency.ticket_id.padStart(4, '0') }}
                                                        </h5>
                                                        <h5 v-if="currency.source == 'API'" style="color: #98a6ad;"><svg
                                                                fill="#000000" height="16px" width="16px" version="1.1"
            ...
            c38.489,10.316,81.823,21.928,92.354,24.75l-18.211,18.209c-2.988,2.989-2.988,7.832,0,10.819l37.289,37.289L252.551,282.904z
             M267.228,219.56c-1.92,3.245-3.972,6.412-6.159,9.488l-9.213-9.213l0.274-0.275H267.228z" />
                                                            ...
                                                            </svg>{{ currency.ticket_id.padStart(4, '0') }}</h5>

                                                        <h5 v-if="currency.source == 'SMS'" style="color: #98a6ad;">
                                                            ...
                                                            {{ currency.ticket_id.padStart(4, '0') }}
                                                        </h5>
                                                        <h5 v-if="currency.source == 'Telegram'" style="color: #98a6ad;">
                                                        ...
                                                        <h5 v-if="currency.source == 'Facebook'" style="color: #98a6ad;">
                                                        ...
                                                        <h5 v-if="currency.source == 'Discord'" style="color: #98a6ad;">
                                                        ...
                                                        <h5 v-if="currency.source == 'Email'" style="color: #98a6ad;">
                                                        ...
                                                        <h5 v-if="currency.source == 'Slack'" style="color: #98a6ad;">
                                                        ...
                                                        <h5 v-if="currency.source == ''" style="color: #98a6ad;">

                                                            {{ currency.ticket_id.padStart(4, '0') }}
                                                        </h5>
                                                        <h5 v-if="currency.source == 'Instagram'" style="color: #98a6ad;">
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"
                                                                width="16px" height="16px">
                                                                <radialGradient id="yOrnnhliCrdS2gy~4tD8ma" cx="19.38"
                                                                ...
                                                                <radialGradient id="yOrnnhliCrdS2gy~4tD8mb" cx="11.786"
                                                                    cy="5.54" r="29.813"
                                                        ...
                                                        <h5 v-if="currency.source == 'Web'" style="color: #98a6ad;">
