                                    ...
                                    <section v-else> 
                                        ...
                                        <div v-else v-for="currency in info "  style="box-shadow: 4px 4px rgba(0,0,0,0.25);"  
                                          :style="{ 'background-color': currency.chat_status, 'border-left': 'solid','border-left': '5px', 'border-left': ['solid','5px','solid 5px'+currency.priority_color]} "
                                            v-on:click="pasar(currency.depto, currency.nombreusuario, currency.lastupdate, currency.ticket_id, currency.source, currency.creacion, currency.topic, currency.status_id, currency.priority_desc, currency.priority_color, currency.asignado, currency.user_id,currency.priority_color)"
                                                ...
                                                <div class="container"   >
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6 align-self-start"
                                                            ...
                                                            <h5 v-if="currency.source == 'API'" style="color: #98a6ad;"><svg fill="#000000"
			 ...
			 M267.228,219.56c-1.92,3.245-3.972,6.412-6.159,9.488l-9.213-9.213l0.274-0.275H267.228z" />
                                                            ...
                                                            <h5 v-if="currency.source == 'Telegram'" style="color: #98a6ad;">
                                                                <svg version="1.1" id="Layer_1"
                                                                    ...
                                                                    y="0px" viewBox="0 0 50 50" width="16px"
                                                                    height="16px"
                    ...
                    <div class="p-2">
                        ...
                        <div v-if="source == 'Google Business '">
                            <div v-for="ext in whapp" style="max-height: 446px">
                                <iframe max-height="200px" width="600 px" height="400 px" frameborder='0'
                        ...
                        <div v-if="source == 'Telegram'">
                            ...
                            <div v-for="ext in whapp" style="max-height: 446px">
                                <iframe max-height="200px" width="800 px" height="400 px" frameborder='0'
                                    allowfullscreen v-bind:src="ext.chat_link"></iframe>
                            </div>
                        </div>
                        <div v-if="source == 'Whatsapp'">
                            <div v-for="ext in whapp" style="max-height: 446px">
                                <iframe class="w-100" max-height="200px" width="800 px" height="400 px" frameborder='0'
                                    allowfullscreen v-bind:src="ext.chat_link"></iframe>
                            </div>
                        </div>
                                        ...
                                        <div class="simplebar-content-wrapper" tabindex="0" role="region"
                                            ...
                                            <div class="simplebar-content" style="padding: 0px 24px;">
                                                <div class="timeline-alt py-0">
                                                    ...
                                                    <div v-for="extrah in historial"
                                                        class="timeline-item extrahistorial2">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <GoogleMap api-key="AIzaSyCpW_qQg8n6GJZ5o22J9MdQqXrzVdx-UHY"
                                        style="width:300px;height:300px;" :center="center" :zoom="15">
