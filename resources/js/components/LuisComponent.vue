                                                ...
                                                <div style="float: left;width: 10px;height: 100px;background: white;"
                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4 align-self-end"><span class="float-end text-muted font-12">{{currency.lastupdate }}</span></div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6 align-self-start"> 
                                                                ...
                                                                <h5>{{currency.logo}}{{ currency.number }}</h5></div>
