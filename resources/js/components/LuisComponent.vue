                                ...
                                <section v-else>
                                    ...
                                    <div v-else v-for="currency in info" class="currency">
                                        ...
                                        <a href="javascript:void(0);" class="text-body">
                                                            <h5 class="mt-0 mb-0 font-14" style="color:#727CF5;position: absolute;">{{ currency.topic }}</h5>
                                                            <div class="d-flex align-items-start mt-1 p-2" v-on:click="pasar(currency.depto, currency.nombreusuario, currency.lastupdate, currency.ticket_id, currency.source)">                                                               
                                                                <div class="w-100 overflow-hidden"  id="{{ currency.ticket_id  }}">
