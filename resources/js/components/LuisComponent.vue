                            ...
                            <div class="col">
                                <div class="card-body py-0 mb-3" data-simplebar style="max-height: 600px">
                                    ...
                                    <section v-else> 
                                        ...
                                        <div v-else v-for="currency in info "  style="box-shadow: 4px 4px rgba(0,0,0,0.25);border-left:2px solid {{ currency.priority_color }}"  
                                          :style="{ 'background-color': currency.chat_status, 'border-left': currency.priority_color} "
                                                ...
                                                <div class="container"   >
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6 align-self-start"
                                                            ...
                                                            <h5 v-if="currency.source == 'Whatsapp'"> <svg style=""
