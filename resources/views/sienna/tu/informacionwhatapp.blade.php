...
src="https://conversations.suricata.chat/?conversationId=<?php echo $resultados[0]->conversation_id; ?>&ticketId=<?php echo $resultados[0]->ticketid;?>&agentName=<?php echo session('nombreusuario');?>&bp_bot_id=<?php echo $bp_bot_id;?>&bp_ws_id=<?php echo $bp_ws_id;?>&bp_webhook_id=<?php echo $bp_webhook_id;?>&merchantId=<?php echo $merchantId;?>" width="100%" class="border rounded-3" style="height: 650px!important;"></iframe>
<?php }
else{?>
