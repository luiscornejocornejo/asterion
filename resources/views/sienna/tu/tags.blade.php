<div id="bs-example-modal-sm-tag" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="dark-header-modalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/tags" method="POST">
                    @csrf
                    <input value="" type="hidden" name="idtickettag" id="idtickettag">
