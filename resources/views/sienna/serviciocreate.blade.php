...
<div id="principal">
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <form action="serviciocreate" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" required class="form-control" name="nombre" id="progresspill-firstname-input">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="descripcion" id="progresspill-lastname-input">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="tabla" class="form-control" id="progresspill-servicetax-input">
                                                        </div>
                                                    </div>
                                                </div>
