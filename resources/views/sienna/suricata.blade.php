                    ...
                    <form id="frmAgregarBienCapitalizable" action="/" method="post"> 
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" style="background-color: #ffc95c;"  class="btn btn-primary  mb-0 " onclick="mensaje('<?php echo $saliente = session('saliente');?>')"  class="  "><span style="color: #495057;">Iniciar</span></button>
                            </div>
                        </div>
                    </form>
                </div>
