    ...
    .then(function (response) {
        ...
        for (i = 0; i < response.data.length; i++) {
            ...
            tt += '<tr class="text-center">' +
                ...
                '<button onclick="pedir(' + response.data[i].ticketid + ')"  class="btn s" type="button" data-bs-toggle="modal" data-bs-target="#bs-example-modal-reclamo"><i class="mdi mdi-account-voice"></i> </button> ' +
