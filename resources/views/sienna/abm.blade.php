    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title bg-dark text-white">Eliminar</h5>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content ">
            <div class="modal-header bg-dark text-white">
                <h4 class="modal-title" id="create-taskdby">Crear</h4>
...
<div id="edit-user-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="dark-header-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content h-100">
            ...
            <div class="modal-body">
                <iframe style="display:block; height: 500px;" class="w-100"  id="editariframe" src="" ></iframe>
            </div>
...
<div class="modal fade" id="ctabm" aria-hidden="true" aria-labelledby="exampleModalToggleLabel"tabindex=" -1">
                                ...
                                <form action="crearticketsiennaclientegetdata" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <input readonly type="number" id="numberclient" name="number_client"
                                                class="form-control" required>
                                        </div>
                                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                            <label for="number-client" class="form-label">Teléfono</label>
                                            <input type="text" id="phone_client" name="phone_client"
                                                class="form-control">
                                        </div>
                                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-1">
                                            <label for="department" class="form-label">Departamento</label>
                                            <select required onchange="topics(this.value)" class="form-select"
                                                name="depto">
                                        ...
                                        <input value="<?php echo session('nombreusuario'); ?>" type="hidden" name="logeado"
                                            id="logeado">
            ...
            <div id="create-ticket-modal-2" class="modal fade" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-content">
                        ...
                        <form method="post" action="/getsalienteticket">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-8 col-sm-12">
                                        <input type="text" class="form-control" name="phone" id="phone"
                                            value="<?php //echo $datosonline2->phone_mobile;
                                            ?>">
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-success" data-bs-dismiss="modal">Enviar
                                    saliente</button>
                            </div>
                        </form>
                    </div><!-- /.modal-content -->
