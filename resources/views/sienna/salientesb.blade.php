        ...
        <div class="container-fluid pt-2">
            ...
            <div id="carga" class="row d-none">
                <form enctype="multipart/form-data" action="/salientesb" method="post" class="dropzone" id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews"
                    ...
                    <table class="table table-hover display responsive nowrap w-100 table-bordered" id="excelTable">
                        <thead></thead>
                        <tbody></tbody>
                    </table>
                    <div class="col-lg-4 col-sm-12">
                        <div class="mb-2 position-relative">
                            ...
                            <input type="submit" role="button" class="form-control w-25 bg-success text-light" value=">Enviar">
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script>
        document.getElementById('inputFile').addEventListener('change', function(event) {
            ...
            reader.onload = function(event) {
                ...
                thead.innerHTML = ''; // Limpiar thead antes de agregar datos
                tbody.innerHTML = ''; // Limpiar tbody antes de agregar datos
