               ...
               '<br><br><table id="example"  class="table table-striped dt-responsive nowrap w-100 text-light">'+
                ...
                for (i = 0; i < response.data.length; i++) {
                    ...
                    if(response.data[i].siennasource==7){
                      aviso='<a target=blank href=/ticketunico?tick='+response.data[i].ticketid +'><i class="mdi '+im+'  '+im2+' me-1 "></i></a>';
                    }
                    ...
                    tt += '<tr class="text-center">' +
                        ...
                        ' <td> <a onclick="estado2(`' + result + '`,`' + response.data[i].ticketid + '`,`' + response.data[i].conversation_id + '`,`' + response.data[i].iddepto + '`)"><span class="badge '+colorestado+'" style="font-size:medium; ">' + response.data[i].estadoname + '</span></a>'+
