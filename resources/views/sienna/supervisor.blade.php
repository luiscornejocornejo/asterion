      ...
      <div class="content-page" style="padding: 0!important;">
        ...
        @endif
            ...
            if(($subdomain_tmp=="soporte") and (session('tokeninterno')<>0)){?>
              <div class="">
                        <iframe sandbox="allow-same-origin allow-scripts allow-popups allow-forms" allow="camera;microphone" src="https://view-sip.pagoralia.dev/?token=9999&merchant=<?php echo $subdomain_tmp;?>" width="100%" class="border rounded-3" style="height: 720px!important;"></iframe>
                    </div>
