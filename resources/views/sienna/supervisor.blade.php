              ...
              const newData = response.data;
                ...
                for (i = 0; i < response.data.length; i++) {
                    ...
                    tt += '<tr class="text-center">' +
                        ...
                        '<td> <span style="font-size:medium;" class="badge '+colorestado+'" onclick="estado2(`' + result + '`,`' + response.data[i].ticketid + '`,`' + response.data[i].conversation_id + '`,`' + response.data[i].iddepto + '`)"  class="badge bg-'+colorestado2+' " style="font-size: medium" role="button" data-bs-toggle="modal" data-bs-target="#bs-example-modal-sm">' + response.data[i].estadoname + ' </span></td> ' +
