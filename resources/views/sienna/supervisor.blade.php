...
<script>
        ...
        function maxid() {
            ...
            .then(function (response) {
                ...
                '<button onclick="prioridadall()"  class="btn btn-success  " type="button" data-bs-toggle="modal" data-bs-target="#bs-example-modal-prioridadall">p</button> '+
               '  <button type="button" onclick="selects()" ><i class="mdi mdi-format-list-checks" ></i></button>'+  
              ' <button type="button" onclick="deSelect()" ><i class="mdi mdi-Deselect-all" ></i></button>'+
