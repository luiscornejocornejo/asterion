        ...
        function maxid() {
           //document.body.style.zoom = "80%";
            ...
            .then(function (response) {
                ...
                '<button onclick="areaall()"  class="btn btn-info me-1" type="button" data-bs-toggle="modal" data-bs-target="#bs-example-modal-sm2"><i data-toggle="tooltip" data-bs-title="Departamento" class="mdi mdi-account-group"Asignar departamento."></i> </button>'+
