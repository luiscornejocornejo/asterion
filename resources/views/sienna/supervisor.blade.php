              ...
              const newData = response.data;
                ...
                for (i = 0; i < response.data.length; i++) {
                    ...
                    tt += '<tr class="text-center">' +
                        ...
                        '<td><span class="badge '+colordepto+'" style="font-size:medium;" onclick="area(`' + response.data[i].ticketid + '`,`' + response.data[i].conversation_id + '`,`' + response.data[i].user_id + '`)"  class="badge bg-info" style="font-size: medium" role="button" data-bs-toggle="modal" data-bs-target="#bs-example-modal-sm202">'+response.data[i].depto+' </span></td>' +
