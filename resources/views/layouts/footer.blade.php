<div class="main-content" id="miniaresult">
    ...
    <!-- JAVASCRIPT -->
    <script src="https://siennasystem.com/assets/libs/jquery/jquery.min.js"></script>
    <script src="https://siennasystem.com/assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="https://siennasystem.com/assets/libs/metismenu/metisMenu.min.js"></script>
    <script src="https://siennasystem.com/assets/libs/simplebar/simplebar.min.js"></script>
    <script src="https://siennasystem.com/assets/libs/node-waves/waves.min.js"></script>
    <script src="https://siennasystem.com/assets/libs/feather-icons/feather.min.js"></script>
    <!-- pace js -->
    <script src="https://siennasystem.com/assets/libs/pace-js/pace.min.js"></script>

    <script src="https://maps.google.com/maps/api/js?key=AIzaSyCtSAR45TFgZjOs4nBFFZnII-6mMHLfSYI"></script>

    <script src="https://siennasystem.com/assets/js/app.js"></script>

    <script src="https://siennasystem.com/assets/js/ajax.js"></script>
