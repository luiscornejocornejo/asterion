...
class TicketdatosController extends Controller
{
    ...
    public function empresadatos2(Request $request)
    {
        ...
        $query="update empresa set zona='".$zona."',frecuencia='".$frecuencia."',reabrir='".$reabrir."' where id='1'";
    ...
    function cabezerasgraficos($datos)
  {
    ...
    public function ticketunico(Request $request)
    {
        ...
        a.id as ticketid,c.nombre estadoname,d.nombre topicname,a.cel numerocel,a.asignado,a.email eltexto,a.nya emailnom,a.cliente emailcliente,
        ...
        $query50="select *, convertirTiempo(created_at) as created_at  from siennaseguimientos where ticket='".$tick."'";
