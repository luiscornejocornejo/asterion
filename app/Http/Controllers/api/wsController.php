    ...
    public function cambiartopicsienna(Request $request){
      ...
      public function cambiardeptosienna(Request $request){
        ...
        $headers = array(
            ...
            $url="https://suricata4.com.ar/api/Behaviour?token=EDElDqlQf3RDP5EDK1pHhugV9M6aCXtwAm57SD0G5JYZjw7RxwZbbfdKMhWYdUUM&idbot=".$idbot."&idconv=".$idconv."&behaviour=".$behaviour."&interaction=".$interaction;
        // Set options for the cURL request
        $options = array(
            CURLOPT_URL => $url,
            CURLOPT_RETURNTRANSFER => true,
