...
class siennaticketsController extends Controller
{
  ...
  //   echo $datosonline;
   // dd("hola");
    ...
    public function iclass(Request $request)
    {
        ...
        foreach ($datoscliente as $value2) {
            ...
            $ticerp= file_get_contents("https://".$subdomain_tmp.".suricata-custom.com.ar/api/iclass_get_so_bycustomer?token=".$tokensienna."&idCustomer=" . $cliente);
                                ...
                                <div class="col-xxl-5 col-xl-5 col-lg-5 col-sm-12 mb-2">
                                    ...
                                    <select class="form-select js-example-basic-single" name="categoria" id="agent">
                                        ...
                                        <?php for($i=0;$i<sizeof($categorias2);$i++){
                                                ?>
                                        <option value="<?php echo $categorias2[$i]['id'] ;?>">
                                            <?php echo $categorias2[$i]['descripcion'] ;?>
                                        </option>
                                        <?php }
    ...
    public function mikrowisp(Request $request){
                        ...
                        <table id="casadepapel" class="table table-striped dt-responsive nowrap w-100 text-light">
                            ...
                            <tbody id="log">
                                <?php for($i=0;$i<sizeof($dataContent['tickets']);$i++){
                                                ?>
                                <tr class="text-center">
                                    <td><a target='_blank' href='<?php echo $dataContent['tickets'][$i]['id'] ;?>'><?php echo $dataContent['tickets'][$i]['id'] ;?></a> </td>
                                    <td><?php echo $dataContent['tickets'][$i]['fecha_soporte'];?>
                                    </td>
                                    <td> <?php echo  $dataContent['tickets'][$i]['estado'] ;?> </td>

                                    <td><?php echo  $dataContent['tickets'][$i]['asunto'] ;?> </td>
    ...
    public function ispkipper(Request $request){

        $cliente=$request->cliente;

        $subdomain_tmp=$request->subdomain_tmp;
        if($subdomain_tmp=="celer"){
            $subdomain_tmp="celler";
        }
        ...
        $getdata= file_get_contents("https://".$subdomain_tmp.".suricata-ispkeeper.com.ar/api/wsn?token=".$tokensienna."&cliente_id=" . $cliente);
        $getdata2 = json_decode($getdata, true);
        ...
        $ticketserp = file_get_contents("https://".$subdomain_tmp.".suricata-ispkeeper.com.ar/api/tickets?token=".$tokensienna."&cliente_id=" . $cliente);
                                ...
                                <div class="col-xxl-5 col-xl-5 col-lg-5 col-sm-12 mb-2">
                                    ...
                                    <select class="form-select js-example-basic-single" name="usuarios" id="agent">
                                        ...
                                        <?php for($i=0;$i<sizeof($usuariosserp2);$i++){
                                                ?>
                                        <option value="<?php echo $usuariosserp2[$i]['usuario_id'] ;?>">
                                        <?php echo $usuariosserp2[$i]['usuario_nombre']  ;?>
                                           <?php echo $usuariosserp2[$i]['usuario_apellido'] ;?>
                                        </option>
                                        <?php }
                        ...
                        <table id="casadepapel" class="table table-striped dt-responsive nowrap w-100 text-light">
                            ...
                            <tbody id="log">
                                <?php for($i=0;$i<sizeof($ticketserp2);$i++){
                                                ?>
                                <tr class="text-center">
                                    <td><a target='_blank' href='<?php echo $urilogin;?><?php echo $ticketserp2[$i]['ticket_id']  ;?>'><?php echo $ticketserp2[$i]['ticket_id']  ;?></a> </td>
                                    <td><?php echo $ticketserp2[$i]['ticket_dia'] ." ". $ticketserp2[$i]['ticket_hora']  ;?>
                                    </td>
    ...
    public function ispcube(Request $request){
        ...
        $ticerp= file_get_contents("https://".$subdomain_tmp.".suricata2.com.ar/api/gettickets?token=".$tokensienna."&codcli=" . $cliente);
        $ticerp2=json_decode($ticerp, true);
        $categorias= file_get_contents("https://".$subdomain_tmp.".suricata2.com.ar/api/categories?token=".$tokensienna."");
        $categorias2=json_decode($categorias, true);
        $getdata= file_get_contents("https://".$subdomain_tmp.".suricata2.com.ar/api/ws?token=".$tokensienna."&codcli=" . $cliente);
        $getdata2 = json_decode($getdata, true);
                    ...
                    <div class="tab-pane show active" id="ticket">
                        ...
                        <table id="casadepapel" class="table table-striped dt-responsive nowrap w-100 text-light">
                            ...
                            <tbody id="log">
                                ...
                                <tr class="text-center">
                                    <td><a target='_blank' href='<?php echo $urilogin;?><?php echo $ticerp2[$i]['id'] ?>'><?php echo $ticerp2[$i]['id'];?></a> </td>
                                    <td><?php echo  $ticerp2[$i]['visit_date']; ?>
                                    </td>
