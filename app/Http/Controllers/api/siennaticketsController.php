    ...
    public function creartickessienna(Request $request)
    {
        ...
        if($siennaestado==4){
            ...
            $headers = array(
                ...
                echo  $url="https://suricata4.com.ar/api/closechat?token=EDElDqlQf3RDP5EDK1pHhugV9M6aCXtwAm57SD0G5JYZjw7RxwZbbfdKMhWYdUUM&idbot=".$merchant."&idconv=".$conversation_id."&bot_channel=".$bot_channel;
