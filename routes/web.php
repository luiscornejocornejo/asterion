...
Route::group(['middleware' => ['reportes']], function() {
    ...
    Route::get('/estudio/{id}', 'App\Http\Controllers\ibbvpController@estudio');
...
Route::post('/botsalientes','App\Http\Controllers\SalientesController@botsalientespost'); 
...
Route::post('/pagoraliaorden','App\Http\Controllers\cloudtickets@pagoraliaorden');
